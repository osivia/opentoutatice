                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="background-color:#fff;padding:8px 20px;"><br/>
                        ...
                        Une t&eagrave;che sur le document <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">${htmlEscape(docTitle)}</a> <strong>vous a &eacute;t&eacute; assign&eacute;</strong> or to a group you belong to.
                        </p><br/>
                        <p style="margin:0;font-size:13px;">
                          <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">&#187; Voir la t&eagrave;che sur ${htmlEscape(docTitle)}</a>
                        </p><br/>
                     </td>
                    </tr>
                  </tbody>
