...
public class TinyMCELinksTest {
    ...
    public static final String[] NX_SRC_LINKS = {"web/bernie-mini3?content=Medium", "nxfile/default/attachedImages/ttc:images/0/file/chat.jpeg",
            "nxfile/default/1234567891011_creatingDoc/ttc:images/0/file/chat.jpeg",
            "nxfile/default/df253d7f-8811-42d7-b853-512df435c1b0/ttc:images/0/file/rat.jpg?conversationId=0NXMAIN1"};

    /** Set of relative Nx resources URLs. */
    public static final String[] NX_DOWNLOAD_SRC_LINKS = {
            "nxfile/default/1182d4e1-81bc-4e96-bf8e-b4e2bc6bdcd6/blobholder:0/Erreurs%20%C3%A0%20l'import%20de%20fichiers.txt"};
    ...
    public static final String[] NX_DOC_LINKS = {"nxdoc/default/dcb06690-4e47-4af3-8c29-404e48a1f3e1/view_documents",
    ...
    public void test_links() throws Exception {
        ...
        String[][] POSSIBLE_LINKS = {NX_SRC_LINKS};
    ...
    public void test() {
        ...
        // final String test3 =
        // "SQL: SELECT \"hierarchy\".\"id\" AS \"_C1\" FROM \"hierarchy\" LEFT JOIN \"misc\" \"_F1\" ON \"hierarchy\".\"id\" = \"_F1\".\"id\" WHERE
        // ((\"hierarchy\".\"primarytype\" IN ('ServiceMetier', 'SectionRoot', 'Annonce', 'Workspace', 'RelationSearch', 'user_open_tasks_cv', 'Alerte', 'Room',
        // 'UserWorkspace', 'BlogSite', 'FacetedSavedSearchesFolder', 'Thread', 'WebConfigurationFolder', 'ProceduresContainer', 'TemplateRoot',
        // 'DocumentRouteStep', 'PortalSite', 'Domain', 'Collections', 'ProceduresInstancesContainer', 'WorkspaceRoot', 'Zoom', 'ContactMessage', 'QueryNav',
        // 'ToutaticePad', 'SimpleTask', 'Agenda', 'PortalPage', 'ContactMessageFolder', 'WebPage', 'VEVENT', 'ConditionalTask', 'Video', 'MailMessage',
        // 'Forum', 'PictureBook', 'ContextualLink', 'ProcedureInstance', 'WebConfiguration', 'doc_acaren_advanced_search', 'Question', 'AssetLibrary',
        // 'PortalVirtualPage', 'FollowLifeCycleTransitionTask', 'Staple', 'PublishTask', 'Picture', 'Collection', 'Document', 'FaqFolder', 'Folder',
        // 'FacetedSearch', 'MediaLibrary', 'File', 'DocumentUrl', 'WebSite', 'AdvancedSearch', 'Note', 'Favorites', 'Section', 'ProcedureModel',
        // 'DocumentUrlContainer', 'doc_toutatice_image_search', 'MailFolder', 'ProceduresModelsContainer', 'OrderedFolder', 'Audio', 'BasicAuditSearch',
        // 'AnnonceFolder', 'BlogPost')) AND (\"hierarchy\".\"isversion\" IS NULL) AND (\"_F1\".\"lifecyclestate\" <> 'deleted') AND (EXISTS(SELECT 1 FROM
        // ancestors WHERE id = \"hierarchy\".\"id\" AND ARRAY['3c018468-2936-4f68-9bcd-71cf1c8b3cec'] <@ ancestors))) -- LIMIT 20 OFFSET 0 -- COUNT TOTAL UP TO
        // 200{{RemoteAddr,127.0.0.1}{RequestURL,http://mig44dch/nuxeo/search/search.faces}{ServletPath,/search/search.faces}{SessionID,B9CC1877D611B669F38C720A53F49F0B.nuxeo}{UserPrincipal,Administrator}}";
