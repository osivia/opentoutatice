...
tinymce.PluginManager.add('ottc_basiclink', function(editor) {
	...
	function showDialog(linkList) {
		...
		data.target = anchorElm ? dom.getAttrib(anchorElm, 'target') : (editor.settings.default_link_target || '_blank');
		...
		if (editor.settings.target_list !== false) {
			targetListCtrl = {
				...
				type: 'listbox',
				label: 'Target',
				values: buildValues('target_list', 'target', [{text: 'New tab', value: '_blank'}, {text: 'Same tab', value: ''}])
			};
		}
	...
	editor.addButton('ottc_basiclink', {
		icon: 'link',
	...
	editor.addMenuItem('ottc_basiclink', {
		icon: 'link',
		text: 'Insert link',
		shortcut: 'Ctrl+K',
		onclick: createLinkList(showDialog),
