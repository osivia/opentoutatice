 ...
 ** All rights reserved.This program and the accompanying materials*are made available under the terms of the GNU Lesser General Public License*(LGPL)version 2.1
 * which accompanies this distribution,and is available at*http:// www.gnu.org/licenses/lgpl-2.1.html
 ** This library is distributed in the hope that it will be useful,*but WITHOUT ANY WARRANTY;without even the implied warranty of*MERCHANTABILITY or FITNESS FOR
 * A PARTICULAR PURPOSE.See the GNU*Lesser General Public License for more details.***Contributors:*mberhaut1*dchevrier*lbillon
 **/
...
public class ToutaticePictureManagerBean extends PictureManagerBean {
    ...
    /* FIXME: fork */
    protected void downloadWebIdFile(DocumentView docView, ToutaticeDocumentLocation docLoc) throws PropertyException, NuxeoException, IOException {
        // fix for NXP-1799
        ...
        if (CollectionUtils.isNotEmpty(docs) && docs.size() > 0) {
            ...
            ComponentUtils.downloadFile(blob.getFile(), fileName, "picture");
        }
