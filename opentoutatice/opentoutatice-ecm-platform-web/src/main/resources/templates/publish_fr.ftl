                  ...
                  <tbody>
                    <tr>
                      ...
                      <#if eventId == "documentPublished">
                        ...
                        Le document ${htmlEscape(docTitle)} a &eacute;t&eacute; <strong>publi&eacute</strong>.
                        </p><br/>
                        <table cellpadding="6" cellspacing="0" style="border:none;border-collapse:collapse;font-size:13px;">
                          <tbody>
                           <tr>
                            ...
                            <tr>
                              <td style="border:1px solid #eee;color:#888;font-size:13px;white-space:nowrap;">Par</td>
                        ...
                        <p style="margin:0;font-size:13px;">
                          <a style="color:#22aee8;text-decoration:underline;word-wrap:break-word !important;" href="${docUrl}">&#187; Consultez le document ${htmlEscape(docTitle)}</a>
                        </p><br/>
                      <#elseif eventId == "documentPublicationApproved">
                        <p style="margin:0;font-size:13px;">
                        Le document ${htmlEscape(docTitle)} a &eacute;t&eacute; <strong>approuv&eacute;</strong>.
                        </p><br/>
                        <table cellpadding="6" cellspacing="0" style="border:none;border-collapse:collapse;font-size:13px;">
                          <tbody>
                            <tr>
                      ...
                      <#elseif eventId == "documentPublicationRejected">
                        <p style="margin:0;font-size:13px">
                        Le document ${htmlEscape(docTitle)} a &eacute;t&eacute; <strong>rejet&eacute;</strong>.
                        </p><br/>
                        <table cellpadding="6" cellspacing="0" style="border:none;border-collapse:collapse;font-size:13px;">
                          <tbody>
                            <tr>
                            ...
                            <tr>
                              <td style="border:1px solid #eee;color:#888;font-size:13px;">Identifiant du document</td>
                              <td style="border:1px solid #eee;color:#000;font-size:13px;"><a href="${docUrl}" style="color:#22aee8;text-decoration:underline;word-wrap:break-word!important;">
                              ${htmlEscape(docId)}</a>
                              </td>
                            </tr>
                    ...
                    <tr>
                      <td style="background-color:#f7f7f7;border-top:1px dashed #e9ecef;text-align:center;padding:8px 20px;">
                        ...
                        Vous avez re&ccedil;u cette notification car vous avez souscrit à ${notification.name?lower_case} sur ce document ou l'un de ses parents.</div>
                      </td>
                    </tr>
                  </tbody>
                </table>
