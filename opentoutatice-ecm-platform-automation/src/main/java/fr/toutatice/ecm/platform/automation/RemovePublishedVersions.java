...
@Operation(
        id = RemovePublishedVersions.ID,
        category = Constants.CAT_DOCUMENT,
        label = "Remove all published versions of a document",
        description = "Remove all published versions of a document among its versions series and inside a specific target folder/section. Return the input document.")
