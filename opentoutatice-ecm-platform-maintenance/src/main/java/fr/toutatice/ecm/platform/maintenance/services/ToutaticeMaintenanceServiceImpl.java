...
import fr.gouv.education.acrennes.ged.constants.NuxeoStudioConst;
import fr.gouv.education.acrennes.ged.helper.UserMngtHelper;
...
public class ToutaticeMaintenanceServiceImpl extends DefaultComponent implements ToutaticeMaintenanceService {
	...
	private class MntDocumentGetter extends UnrestrictedSessionRunner {
		...
		public void run() throws ClientException {
			...
			List<String> administrators = UserMngtHelper.instance().getSuperAdministrators();
