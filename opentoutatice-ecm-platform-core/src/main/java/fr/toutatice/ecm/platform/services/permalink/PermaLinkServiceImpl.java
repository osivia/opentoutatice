...
public class PermaLinkServiceImpl extends DefaultComponent implements PermaLinkService {
    ...
    public void registerContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (PERMALINKS_EXTENSION_POINTS.equals(extensionPoint)) {
            ...
            log.debug((new StringBuilder()).append(" Added descriptor ").append(permalinkName).toString());
        }
    ...
    public void unregisterContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (PERMALINKS_EXTENSION_POINTS.equals(extensionPoint)) {
            ...
            permalinkImpls.remove(permalinkName);
            log.debug((new StringBuilder()).append(" remove descriptor ").append(permalinkName).toString());
        }
